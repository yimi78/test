...
public class AESUtils {
	...
	// 加密
	public  String Encrypt(String sSrc, byte[] key, byte[] iv)
			throws Exception {
	...
	// 解密
	public  String Decrypt(String sSrc, byte[] raw, byte[] iv)
			throws Exception {
		try {
	...
	//
	// String DeString = Decrypt(ttt.toUpperCase(), parseHexStr2Byte(Key),
	// parseHexStr2Byte(Iv));
	//
